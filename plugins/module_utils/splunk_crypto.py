"""
Crypto helpers for Splunk secrets ($1$ RC4 and $7$ AES-GCM).

Based on/derived from:
    https://github.com/HurricaneLabs/splunksecrets (file: splunk.py)

Minor adaptations for Ansible module_utils layout.
"""
